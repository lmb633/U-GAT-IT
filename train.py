...
class UGATIT(object) :
    ...
    def train(self):
        ...
        for step in range(start_iter, self.iteration + 1):
            ...
            G_loss_A =  self.adv_weight * (G_ad_loss_GA + G_ad_cam_loss_GA  ) + self.cycle_weight * G_recon_loss_A + \
                        self.identity_weight * G_identity_loss_A + self.cam_weight * G_cam_loss_A
            G_loss_B = self.adv_weight * (G_ad_loss_GB + G_ad_cam_loss_GB  ) + self.cycle_weight * G_recon_loss_B + \
                       self.identity_weight * G_identity_loss_B + self.cam_weight * G_cam_loss_B
